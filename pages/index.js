    ...
    <div className="relative h-[200vh]">
      ...
      <div className="w-full absolute top-[40%] text-center flex justify-center flex-col items-center">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="60.686" height="25.734" viewBox="0 0 60.686 25.734">
          <line id="Line_13" data-name="Line 13" x2="27" y2="25" transform="translate(0.34 0.367)" fill="none" stroke="#000" stroke-width="1" />
          <line id="Line_15" data-name="Line 15" x2="27" y2="25" transform="translate(7.34 0.367)" fill="none" stroke="#000" stroke-width="1" />
          <line id="Line_14" data-name="Line 14" x1="26" y2="25" transform="translate(27.34 0.367)" fill="none" stroke="#000" stroke-width="1" />
          <line id="Line_16" data-name="Line 16" x1="26" y2="25" transform="translate(34.34 0.367)" fill="none" stroke="#000" stroke-width="1" />
        </svg>
      </div>
